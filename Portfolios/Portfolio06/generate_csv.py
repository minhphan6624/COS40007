...
test_labels_path = 'data/bounding_boxes/test_labels.csv'  
test_labels_df = pd.read_csv(test_labels_path)

# Folder where YOLOv5 detection results are saved
detection_folder = '../../../../../references/yolov5/runs/detect/exp3/labels' 

# Path to the folder where your test images are stored
test_images_folder = '../../../../../references/yolov5/dataset/test/images'  # Replace with the path to your test images folder
    ...
    if os.path.exists(detection_file):
        with open(detection_file, 'r') as f:
            for line in f:
                ...
                # Store all detections for each image
                results.append([filename, confidence, iou])
    else:
...
output_csv = 'outputCSV\iter-no.csv'
